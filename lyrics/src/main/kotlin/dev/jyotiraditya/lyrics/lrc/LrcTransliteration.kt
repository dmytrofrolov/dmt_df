...
/** How far apart two lines meant to be shown together are still written, in milliseconds. */
private const val TOGETHER_MS = 150L
...
/**
 * Whether [other] starts when [this] does, which a file writes as near enough the same time rather
 * than exactly it.
 */
private fun LyricLine.startsWith(other: LyricLine): Boolean =
    abs(startMs - other.startMs) <= TOGETHER_MS
